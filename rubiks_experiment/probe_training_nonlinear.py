...
class NonLinearProbe(t.nn.Module):
    """
    A set of sticker_locs probes, each of size d_model -> n_colors,
    with hidden layer of size d_model -> d_model
    and output layer of size d_model -> n_colors
    """
    def __init__(self, d_model, n_colors, hidden_size=256):
        super().__init__()
        self.d_model = d_model
        self.n_colors = n_colors
        self.hidden_size = hidden_size
        self.sticker_locs = 24
        self.in_tensor = t.randn()
